...
(function(factory) {
	...
	$.fn.ajaxSubmit = function(options) {
		...
		function fileUploadIframe(a) {
			...
			var httpData = function(xhr, type, s) { // mostly lifted form jq1.4.4
			...
			function() {
				if (!this.loaded) {
					...
					function() {
						...
						/* Remove image form array so it is not looped next time. */
...
(function(document, window, index) {
	...
	*/
		...
		/**
	* Remove a class form any element
	*
	* @param  {element} element
	* @param  {string}  class
	*/
...
function($) {
	...
	var Slider; (function($) {
		...
		// get jquery form browser global
		defineBridget($);
	})($);
	/*************************************************
	...
	**************************************************/
	(function($) {
		var ErrorMsgs = {
			...
			callingContextNotSliderInstance: "Calling context element does not have instance of Slider bound to it. Check your code to make sure the JQuery object returned form the call to the slider() initializer is calling the method"
		};
		...
		**************************************************/
		Slider.prototype = {
			...
			destroy: function() {
				...
				// Remove the slider form the DOM
			...
			********************************/
			_removeSliderEventHandlers: function() {
				// Remove event listeners form handle1
				this.handle1.removeEventListener("keydown", this.handle1Keydown, false);
				this.handle1.removeEventListener("focus", this.showTooltip, false);
				this.handle1.removeEventListener("blur", this.hideTooltip, false);

				// Remove event listeners form handle2
				this.handle2.removeEventListener("keydown", this.handle2Keydown, false);
				this.handle2.removeEventListener("focus", this.handle2Keydown, false);
				this.handle2.removeEventListener("blur", this.handle2Keydown, false);

				// Remove event listeners form sliderElem
			...
			_keydown: function(handleIdx, ev) {
				...
				// use natural arrow keys instead of form min to max
