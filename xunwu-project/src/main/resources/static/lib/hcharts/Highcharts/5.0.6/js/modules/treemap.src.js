...
(function(factory) {
    ...
    (function(H) {
        ...
        seriesType('treemap', 'scatter', {
            ...
            /**
             * Creates an object map form parent id to childrens index.
             * @param {Array} data List of points set in options.
             * @param {string} data[].parent Parent id of point.
             * @param {Array} ids List of all point ids.
             * @return {Object} Map form parent id to children index in data.
             */
            ...
            /**
             * Creates a tree structured object form the series points
             */
            getTree: function() {
                var tree,
                    series = this,
            ...
            translate: function() {
                ...
                // Create a object map form level to options
            ...
            getExtremes: function() {
                // Get the extremes form the value data
                Series.prototype.getExtremes.call(this, this.colorValueData);
                this.valueMin = this.dataMin;
                this.valueMax = this.dataMax;

                // Get the extremes form the y data
