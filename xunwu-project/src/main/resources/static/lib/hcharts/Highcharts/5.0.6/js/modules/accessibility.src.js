    ...
    (function(H) {
        ...
        H.wrap(H.Series.prototype, 'init', function(proceed) {
            ...
            if (chart.options.accessibility.enabled) {
                ...
                addEvent(this, 'remove', function() {
                    ...
                    // Check if any of the other series have the same type as this one. Otherwise remove it form the list.
        ...
        H.Chart.prototype.addKeyboardNavEvents = function() {
            ...
            chart.keyboardNavigationModules = [
                ...
                navModuleFactory([
                    ...
                    // If coming back to points form other module, highlight last point
                ...
                navModuleFactory([
                    ...
                    init: function(direction) {
                        ...
                        // If coming back to export menu form other module, try to highlight last item in menu
                ...
                navModuleFactory([
                    ...
                    // Handle tabs different form left/right (because we don't want to catch left/right in a text area)
                    transformTabs: false,
        ...
        H.Chart.prototype.addScreenReaderRegion = function(tableId) {
            var chart = this,
                ...
                hiddenStyle = { // CSS style to hide element form visual users while still exposing it to screen readers
                    position: 'absolute',
                    left: '-9999px',
                    top: 'auto',
                    width: '1px',
        ...
        H.Chart.prototype.callbacks.push(function(chart) {
            ...
            // Hide text elements form screen readers
            ...
            /* Wrap table functionality form export-csv */
