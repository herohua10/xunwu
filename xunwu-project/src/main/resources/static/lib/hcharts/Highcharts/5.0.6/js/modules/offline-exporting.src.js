...
(function(factory) {
    ...
    (function(Highcharts) {
        ...
        // Get blob URL form SVG code. Falls back to normal data URI.
        ...
        Highcharts.downloadSVGLocal = function(svg, options, failCallback, successCallback) {
            ...
            function downloadPDF() {
                ...
                each(textElements, function(el) {
                    ...
                    // Workaround for plotband with width, removing title form text nodes
            ...
            if (imageType === 'image/svg+xml') {
                ...
                // PNG/JPEG download - create bitmap form SVG
